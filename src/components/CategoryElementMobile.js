        ...
        <div >
            <Container maxWidth='md'>
                <Card variant='elevation'>
                    <CardContent>
                    <ArrowBackIcon onClick={() => props.openCategory({top : false})} style={{color : '#f9572f'}}/>
                        ...
                        <Grid container
                            ...
                            <Grid align="center" item xs={12} sm={4}>
                                <FormControl fullWidth style={{maxWidth : '90%'}} variant='standard' className={classes.formControl}>
